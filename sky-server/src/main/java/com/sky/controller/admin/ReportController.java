...
public class ReportController {
    ...
    @ApiOperation("订单统计")
    public Result<OrderReportVO> oderStatistics(@DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate begin ,
                                                @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate end){
